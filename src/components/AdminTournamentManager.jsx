...
export function AdminTournamentManager({ tournament, onBack, onChanged }) {
  ...
  const [selectedRosterGroupId, setSelectedRosterGroupId] = useState('ALL')
  ...
  const rosterTeams = selectedRosterGroupId === 'ALL'
    ? teams
