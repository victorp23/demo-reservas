...
export function LocationSection({ complex }) {
  ...
  return <section className="location-section" id="ubicacion">
    <div className="location-heading">
      ...
      <h2>Visítanos</h2>
      <p>{complex.address || 'Consulta nuestra ubicación en Google Maps.'}</p>
      {complex.mapsUrl && <a href={complex.mapsUrl} target="_blank" rel="noreferrer">Abrir en Google Maps <ExternalLink size={15} /></a>}
    </div>
